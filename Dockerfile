...
# Install Terraform
RUN curl -LO "https://releases.hashicorp.com/terraform/1.6.6/terraform_1.6.6_linux_amd64.zip" && \
...
# Clean up
RUN rm -rf terraform_1.6.6_linux_amd64.zip linux-amd64 helm-v3.8.0-linux-amd64.tar.gz
